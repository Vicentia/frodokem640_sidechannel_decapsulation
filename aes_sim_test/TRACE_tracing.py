...
def run_decapsulation_worker(worker_args, mode):
    ...
    # timed_decapsulation_start_time = namespace.get("decapsulation_start_time") or decapsulation_start_time
    # timed_decapsulation_start_instr = namespace.get("decapsulation_start_instr")
    # if timed_decapsulation_start_instr is None:
    #     timed_decapsulation_start_instr = decapsulation_start_instr
    #
    # append_timing_row(config["output_dir"], {
    ...
    #     "fault_index": config.get("fault_index"),
    #     "random_index": config.get("random_index"),
    #     "seconds": time.perf_counter() - timed_decapsulation_start_time,
    #     "emulated_instructions": namespace.get("instr_counter", 0) - timed_decapsulation_start_instr,
    #     "total_emulated_instructions": namespace.get("instr_counter", 0),
    # })
