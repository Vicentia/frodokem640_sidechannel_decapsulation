...
def return_instruction_type(instr):
    ...
    arithmetic = {
        ...
        'MUL', 'MLA',
        'SMULL', 'UMULL',
        'SMLAD', 'SMLAL', 'SMLABB', 'SMLABT', 'SMLATB', 'SMLATT',
    ...
    if instr in arithmetic or instr_base in arithmetic:
        return 'arithmetic', 'ARM'

    elif instr in load_store or instr_base in load_store:
        return 'load_store', 'ARM'

    elif instr in branch_jump or instr_base in branch_jump:
        return 'branch_jump', 'ARM'

    elif instr in floating_point or instr_base in floating_point:
        return 'floating_point', 'ARM'
