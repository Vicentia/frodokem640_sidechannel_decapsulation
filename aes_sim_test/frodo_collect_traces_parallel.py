...
from path_helpers import get_snapshot_path
...
from tracing import make_snapshot_tracing, run_parallel_decapsulation_worker
...
# main
def main():
    global elf_file, output_dir, output_dir_trim, pk_path, SK_PATH, CT_BASE_PATH
    global global_output_dir, snapshot_path, skip_addrs, clear_bytes_addr
    ...
    load_base_ciphertext_from_path(CT_BASE_PATH)
    ...
    with ctx.Pool(processes=jobs) as pool:
        pool.map(run_parallel_decapsulation_worker, worker_args)
